...
import com.chat.server.config.RequestLoggingFilter;
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Неавторизованные запросы -> 401 (а не 403), чтобы клиенты понимали,
                // что нужно обновить токен/перелогиниться. Иначе клиент с истёкшим
                // токеном получает 403 и не может восстановиться.
